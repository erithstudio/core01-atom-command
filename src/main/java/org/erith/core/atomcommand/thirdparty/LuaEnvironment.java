package org.erith.core.atomcommand.thirdparty;
...
{
    @Tooltip(message = "Start a Lua debug server on scene start.")
    protected boolean startDebugServer = true;

    @Tooltip(message = "Port to use for the Lua debug server.")
...
//        }
    ...
    /// </summary>
//    protected void InitLuaScriptFiles()
//    {
...
//    }
    ...
    /// </summary>
//    protected IEnumerator RunLuaCoroutine(Closure closure, Action<DynValue> onComplete = null)
//    {
...
//    }
    ...
    /// </summary>
//    protected IEnumerator RunUnityCoroutineImpl(IEnumerator coroutine)
//    {
//        if (coroutine == null)
//        {
...
//public Script Interpreter { get { return interpreter; } }
    ...
    /// </summary>
//    public Closure LoadLuaFunction(string luaString, string friendlyName)
//    {
//        InitEnvironment();
//
